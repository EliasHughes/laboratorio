...
_COLLECTIONS: Dict[str, Dict[str, Any]] = {
    # ------------------------------------------------------------------
    # Suite de Colaboración · Iter 24 (Kanban / Notes / Docs polimórficos)
    # ------------------------------------------------------------------
    "kanban_tasks": {
        "extract": [("entity_type", "text"), ("entity_id", "text"),
                    ("column", "text"), ("position", "int"),
                    ("assignee_user_id", "text"),
                    ("closed_at", "dt"), ("updated_at", "dt")],
        "unique": ["id"],
    },
    "notes_blocks": {
        "extract": [("entity_type", "text"), ("entity_id", "text"),
                    ("pinned", "bool"), ("updated_at", "dt")],
        "unique": ["id"],
    },
    "collab_docs": {
        "extract": [("entity_type", "text"), ("entity_id", "text"),
                    ("deleted_at", "dt"), ("uploaded_at", "dt"),
                    ("sha256", "text")],
        "unique": ["id"],
    },
    "users": {
    ...
    # ==== Iter 18 · Almacén de Laboratorio ====
    "lab_locations": {
        "extract": [("code", "code"), ("name", "text"),
                    ("location_type", "text"), ("zone", "text"),
                    ("active", "bool"), ("created_at", "dt")],
        "unique": ["id", "code"],
    },
    "lab_stock_items": {
        "extract": [("code", "code"), ("name", "text"),
                    ("category", "text"), ("lot_number", "text"),
                    ("location_id", "text"), ("expiry_date", "text"),
                    ("quantity", "num"), ("minimum_stock", "num"),
                    ("active", "bool"), ("created_at", "dt")],
        "unique": ["id", "code"],
    },
    "lab_stock_movements": {
        "extract": [("stock_item_id", "text"), ("type", "text"),
                    ("delta", "num"), ("new_quantity", "num"),
                    ("created_at", "dt")],
        "unique": ["id"],
    },
    "lab_stock_transfers": {
        "extract": [("code", "code"), ("direction", "text"),
                    ("status", "text"), ("created_at", "dt")],
        "unique": ["id", "code"],
    },
}
